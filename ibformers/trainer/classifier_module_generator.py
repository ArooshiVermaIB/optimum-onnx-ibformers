...
def write_classifier_module(context: ModelArtifactContext,
                            ib_model_path: str,
                            labels: List[str],
                            model_name: str) -> str:
  ...
  custom_classifier_script = _make_custom_classifier_script_contents(
    ib_model_path, model_name
  )
