...
def _make_custom_classifier_script_contents(model_path: str, model_name: str) -> str:
    return f"""
from instabase.model_utils.classifier_connectors import DocumentSplitterModelServiceConnector, make_register_classifiers_fn
...
class ModelWrapper(DocumentSplitterModelServiceConnector):
  model_name = '{model_name}'
  model_version = '{{{{published_model_version}}}}'
  force_reload = False
  use_parsed_ibocr = True

  def inner_split_doc(self,
