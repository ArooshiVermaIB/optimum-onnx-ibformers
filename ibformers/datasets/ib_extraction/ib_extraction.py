...
from typing import Tuple, List, Dict, Optional, Sequence, NamedTuple, Iterable
...
class IbExtraction(IbDs):
    ...
    def _get_annotation_from_model_service(self, records: List[Tuple]) -> Iterable[ExtractionItem]:
    ...
    def process_item(self, item: ExtractionItem) -> Dict:
        ...
        label_features = get_extraction_labels(ocr_features, anno_fields, label2id, item.label2ann_label_id)
